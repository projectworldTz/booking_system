...
<div class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        @foreach([
            ...
            [__('This Month'),      '$' . number_format($stats['revenue_month'] ?? 0, 0), 'text-navy dark:text-amber-400', 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
            [__('Total Revenue'),   '$' . number_format($stats['total_revenue'] ?? 0, 0), 'text-navy dark:text-amber-400', 'M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185z'],
...
<div class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-3">
        @foreach([
            [__('Total Revenue'),  '$' . number_format($stats['total_revenue'] ?? 0, 0)],
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500">
                        {{ $rt->beds_count }}× {{ $rt->bed_type }} · {{ __('Max') }} {{ $rt->max_guests }} {{ __('guests') }} · ${{ number_format($rt->base_price, 2) }}/{{ __('night') }}
                    </p>
                </div>
            </div>
