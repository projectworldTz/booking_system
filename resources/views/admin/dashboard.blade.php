...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
    ...
    <div class="stat-card">
        ...
        <p class="mt-2 text-3xl font-bold text-slate-900 dark:text-white">TZS {{ number_format($platformStats['total_revenue'], 0) }}</p>
        <p class="mt-2 text-xs text-emerald-600 dark:text-emerald-400 font-medium">
            TZS {{ number_format($platformStats['revenue_month'], 0) }} {{ __('this month') }}
        </p>
    </div>
