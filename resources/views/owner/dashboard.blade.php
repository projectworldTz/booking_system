...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
    @foreach([
        ...
        [__('Month Revenue'),   '$' . number_format($stats['revenue_month'] ?? 0, 0), 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
...
<div class="grid gap-6 lg:grid-cols-2">
    <div class="card">
        ...
        <div class="divide-y divide-slate-100 dark:divide-slate-700">
            ...
            <div class="flex items-center justify-between px-5 py-3">
                ...
                <a href="{{ route('owner.hotels.show', $h) }}" class="btn-ghost btn-sm">{{ __('Manage') }}</a>
            </div>
            @endforeach
        </div>
        @endif
    ...
    <div class="card">
        ...
        @if($recentBookings->isEmpty())
            <p class="p-5 text-sm text-slate-500">{{ __('No recent bookings.') }}</p>
        @else
        <div class="divide-y divide-slate-100 dark:divide-slate-700">
            ...
            <div class="flex items-center justify-between px-5 py-3">
                <div>
                    ...
                    <p class="text-xs text-slate-500">{{ $b->user->name ?? __('Guest') }} · {{ $b->hotel->name ?? '' }}</p>
                </div>
