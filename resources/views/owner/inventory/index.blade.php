...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-5 mb-6">
    @foreach([
        ...
        ['Total Value',      '$' . number_format($summary['total_value'], 0), 'text-purple-600 dark:text-purple-400', 'bg-purple-50 dark:bg-purple-900/20'],
    ] as [$label, $val, $tc, $bg])
                    ...
                    <tbody>
                        ...
                        <tr class="tr-hover" x-data="{ editOpen: false }">
                            ...
                            <td class="text-sm text-slate-600 dark:text-slate-300">
                                {{ $asset->purchase_price ? '$' . number_format($asset->purchase_price * $asset->quantity, 0) : '—' }}
                            </td>
                            <td class="text-xs">
