...
@section('content')
<h2 class="text-3xl font-bold text-slate-900 dark:text-white">{{ __('Create your account') }}</h2>
...
<form method="POST" action="{{ route('register.submit') }}" class="mt-8 space-y-5">
    ...
    <p class="text-center text-xs text-slate-500 dark:text-slate-400">
        ...
        <a href="#" class="underline hover:text-slate-700">{{ __('Terms of Service') }}</a> {{ __('and') }}
        <a href="#" class="underline hover:text-slate-700">{{ __('Privacy Policy') }}</a>.
    </p>
</form>
@endsection
